...
from corehq.form_processor import abstract_models
from corehq.form_processor.abstract_models import AbstractIndexTree
...
class SyncLog(AbstractSyncLog):
    ...
    def __unicode__(self):
        return "%s synced on %s (%s)" % (self.user_id, self.date.date(), self.sync_log_id)
...
class IndexTree(AbstractIndexTree, DocumentSchema):
    """
...
class SimplifiedSyncLog(AbstractSyncLog, abstract_models.AbstractSyncLog):
    """
